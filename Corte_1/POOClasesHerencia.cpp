// Se Crean las diferentes clases que se usaran en el proyecto, Usuario, Administrador, Recursos (Libros, Salas, computadores)
#include "VectorPropioClaseInventario.cpp"
#include <iostream>
#include <string>
#include <tuple>
#include <stdexcept>
...
class Usuario {
    ...
    // Constructor de la clase Usuario, se inicializan los atributos de la clase
        ...
        void solicitarPrestamo() {
            // Metodo que permite al usuario solicitar un prestamo de un recurso
            //Buscar al usuario en la base de datos y verificar si esta. (temporalmente array de arrays)
...
class Administrador : public Usuario {
    ...
    public:
        ...
        Administrador(string nombre, string apellido, string numeroDocumento, string fechaHoraPrestamo, string fechaHoraDevolucion) : Usuario(nombre, apellido, numeroDocumento) {
        ...
        void setFechaHoraPrestamo(string fechaHoraPrestamo) {
            this->fechaHoraPrestamo = fechaHoraPrestamo;
        }
        string getFechaHoraPrestamo() {
            return fechaHoraPrestamo;
        }
        void setFechaHoraDevolucion(string fechaHoraDevolucion) {
            this->fechaHoraDevolucion = fechaHoraDevolucion;
        }
        string getFechaHoraDevolucion() {
        ...
        void registrarUsuario() {
            ...
            cout << "El administrador " << nombre << " " << apellido << " ha registrado un usuario." << endl;
        ...
        void eliminarUsuario() {
            ...
            cout << "El administrador " << nombre << " " << apellido << " ha eliminado un usuario." << endl;
        }
    ...
    public:
        ...
        void prestarRecurso() {
            ...
            cout << "El recurso " << nombre << " ha sido prestado." << endl;
