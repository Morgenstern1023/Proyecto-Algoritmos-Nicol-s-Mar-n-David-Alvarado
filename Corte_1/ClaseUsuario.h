...
class Administrador : public Usuario {
    ...
    public:
        ...
        void aprobarPrestamo(InformacionUsuarios& infoUsuario) {
        ...
        void consultarUsuarios(InformacionUsuarios& infoUsuarios) {
            ...
            // Se recibe por referencia el objeto de la clase InformacionUsuarios para usar el mismo vector de usuarios registrados
            infoUsuarios.mostrarUsuarios();
        }
        ...
        void registrarUsuario(InformacionUsuarios& infoUsuarios) {
            // Metodo que permite al administrador registrar un usuario
            // Se recibe por referencia el objeto de la clase InformacionUsuarios para agregar el nuevo usuario al mismo vector
            ...
            infoUsuarios.push_back(make_tuple(nombreUsuario, apellidoUsuario, documentoUsuario, sanciones));
            cout << "El usuario " << nombreUsuario << " " << apellidoUsuario << " ha sido registrado." << endl;
            totalOperaciones++;
        }

        void eliminarUsuario(InformacionUsuarios& infoUsuarios) {
            // Metodo que permite al administrador eliminar un usuario
            // Se recibe por referencia el objeto de la clase InformacionUsuarios para eliminar el usuario del mismo vector
            ...
            int i;
            for (i = 0; i < infoUsuarios.gettamaño(); i++) {
                auto [nombre, apellido, documento, sanciones] = infoUsuarios.get(i);
                if (documento == documentoUsuarioEliminar) {
                    infoUsuarios.remove(i);
                    break;
                }
